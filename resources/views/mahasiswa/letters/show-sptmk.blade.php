...
@section('title', 'Detail Surat SPTMK')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Detail Surat Pengantar Tugas Mata Kuliah (SPTMK)</h4>
                        <table class="table table-bordered">
                            <tr><th>Nama Lengkap</th><td>{{ $surat->user->nama }}</td></tr>
                            <!-- <tr><th>NRP</th><td>{{ Auth::user()->nrp }}</td></tr> -->
                            <tr><th>Ditujukan Kepada</th><td>{{ $surat->surat_ditujukan_kepada }}</td></tr>
                            <tr><th>Nama Mata Kuliah</th><td>{{ $surat->nama_mata_kuliah }}</td></tr>
                            <tr><th>Kode Mata Kuliah</th><td>{{ $surat->kode_mata_kuliah }}</td></tr>
                            <tr><th>Semester</th><td>{{ $surat->semester }}</td></tr>
                            <tr><th>Data Mahasiswa</th><td>{{ $surat->data_mahasiswa }}</td></tr>
                            <tr><th>Keperluan Pengajuan</th><td>{{ $surat->keperluan_pengajuan }}</td></tr>
                            <tr><th>Topik</th><td>{{ $surat->topik }}</td></tr>
