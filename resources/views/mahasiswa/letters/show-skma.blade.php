...
@section('title', 'Detail Surat SKMA')
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Detail Surat Keterangan Mahasiswa Aktif (SKMA)</h4>
                        <table class="table table-bordered">
                            ...
                            <tr><th>Alamat Lengkap di Bandung</th><td>{{ $surat->alamat_lengkap_bandung }}</td></tr>
